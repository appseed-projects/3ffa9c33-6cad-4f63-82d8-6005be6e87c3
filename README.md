...
- Timestamp: `2022-06-14 09:13`
- Build ID: `3ffa9c33-6cad-4f63-82d8-6005be6e87c3`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3ffa9c33-6cad-4f63-82d8-6005be6e87c3.git
$ cd 3ffa9c33-6cad-4f63-82d8-6005be6e87c3
```
